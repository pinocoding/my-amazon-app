...
function App() {
  ...
  if (currentUser) {
    if (currentUser.uid === "ivMW3nEhllMDXaswQocqJnD8FfC2") {
      console.log("Hello master");
    }
  } else {
    console.log("CurrentUser is not exited");
  }
  const RequireAuth = ({ children }) {
return currentUser.uid === "ivMW3nEhllMDXaswQocqJnD8FfC2" ? console.log("dkm")
  };
