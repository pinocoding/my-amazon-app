...
function Author({ name, infor }) {
  ...
  return (
    <div className="author__section">
      <h3>{t("Popular highlights in this book")}</h3>
      <div>
        <PopularHightLight />
      </div>
      <div className="author__published">
        <h3>{t("From the Publisher")}</h3>
      ...
      <h3 className="author__sectionHeader">{t("Editorial Reviews")}</h3>
      <p className="author__sectionHeader">{t("Review")}</p>
