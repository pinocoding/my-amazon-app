...
function AlSoLike() {
  ...
  return (
    <div style={{ width: "100%" }}>
      ...
      <div style={style}>
        <h4 style={styleDiv}>{t("Top Sellers Of The Day")}</h4>
        <TopSellerDressesTest />
      </div>
      <br />
      <div style={style}>
        <h4 style={styleDiv}> {t("Top Sexy Dresses")}</h4>
        <TopSellerDresses />
      </div>

      <br />
      <div style={style}>
        <h4 style={styleDiv}>{t("Top Smart Watches")}</h4>
        <TopSmartWatches />
      </div>

      <br />
      <div style={style}>
        <h4 style={styleDiv}> {t("Top Books")}</h4>
        <TopSellersInBook />
      </div>

      <br />
      <div style={style}>
        <h4 style={styleDiv}> {t("Top Seller Videos Games")}</h4>
        <TopVideosGames />
      </div>
    </div>
  );
