  ...
  return (
    <div className="home">
      <div className="home__container">
        ...
        <div id="Gaminggears-section" className="home__cardlayout">
          <Card2
            link1="headsets"
            link2="keyboards"
            link3="mouses"
        ...
        <div id="Dresses-section" className="carouseltest">
          <h3 style={styleH}>{t("Top Sellers Of The Day")}</h3>
          <TopSellerDressesTest />
        </div>
        <div id="Books-section" className="carousel">
          <h3 style={styleH}> {t("Top Books")}</h3>
          <TopSellersInBook />
        </div>
        <div className="carousel">
          <h3 style={styleH}> {t("Top Sexy Dresses")}</h3>
          <TopSellerDresses />
        </div>
        <div id="Watches-section" className="carousel">
          <h3 style={styleH}>{t("Top Smart Watches")}</h3>
          <TopSmartWatches />
        </div>

        <div className="carousel">
          <h3 style={styleH}> {t("Top Seller Videos Games")}</h3>
          <TopVideosGames />
        </div>
        ...
        <div id="Toys-section" className="carousel">
          <h3 style={styleH}> {t("Top Toys")}</h3>
          <TopToys />
        </div>
