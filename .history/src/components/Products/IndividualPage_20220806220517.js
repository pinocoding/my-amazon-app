                ...
                <div className="product__description">
                  ...
                  <div className="product__info">
                    <p className="product__description">
                      <ShowMoreLessBtn limit={100}>
                        Lorem ipsum dolor sit, amet consectetur adipisicing
                        elit. Qui accusamus nulla fugit at natus, eaque labore
                        quo aliquam ipsam impedit nostrum nesciunt modi dolores,
                        sint nisi voluptatem recusandae iste enim!
                        {/* {item.description} */}
                      </ShowMoreLessBtn>
                    </p>
                  </div>
