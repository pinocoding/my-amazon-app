                ...
                <div className="individualleft__mainimg">
                  {item.onsales === "best price" && (
                    <div className="individualleft__ribbon">
                      <p>{item.onsales}</p>
                      <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Soluta a illo voluptas eius. Omnis, a similique ea qui, optio corporis delectus commodi soluta reiciendis est sequi distinctio rerum consequatur perspiciatis?</p>
                    </div>
                  )}
