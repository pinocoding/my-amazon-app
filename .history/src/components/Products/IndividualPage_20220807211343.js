      ...
      {itembox.map((item) => {
        return (
          <>
              ...
              <div className="individualright__column">
                ...
                <div className="product__description">
                  ...
                  <div className="product__info">
                    ...
                    {item.author && <div>Hi this is book details</div>}
                    {item.details && (
                      <div>
                        <p>
                          <strong>Brand :</strong> {item.details.brand}
                        </p>
                        <p>
                          <strong>Brand :</strong> {item.details.color}
                        </p>
                        <p>
                          <strong>Brand :</strong> {item.details.connectivity}
                        </p>
                        <p>
                          <strong>Brand :</strong> {item.details.model}
                        </p>
                        <p>
                          <strong>Brand :</strong> {item.details.noise}
                        </p>
                        {/* brand={item.details.brand}
                          color={item.details.color}
                          connectivity={item.details.connectivity}
            ...
            {item.details && <div>Hi this is Product details</div>}
            {item.author && (
