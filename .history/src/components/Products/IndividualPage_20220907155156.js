                ...
                <div className="individualleft__mainimg">
                  {item.onsales === "best price" && (
                    <div className="individualleft__ribbon">
                      <p>{item.onsales}</p>
                      <p className="individualleft__">
                        Lorem, ipsum dolor sit amet consectetur adipisicing
                        elit. Inventore nulla aspernatur ratione quia vero ipsam
                        cum rem porro? Eveniet ea ullam architecto officiis
                        consectetur quis totam, sed ipsa nesciunt eligendi.
                      </p>
                    </div>
                  )}
