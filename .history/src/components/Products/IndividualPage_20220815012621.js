...
function IndividualPage() {
  ...
  if (itembox[0].washdetail === undefined) {
    delete itembox[0].washdetail;
  }
  return (
      ...
      {itembox.map((item, index) => {
        return (
          <div key={index}>
                  ...
                  <div className="product__info">
                    ...
                    {item.washdetail && (
                      <div>
                        ...
                        <div>
                          <p>{item.watcdetail.OperatingSystem}</p>
                          <p>{item.details.SpecialFeature}</p>
                        </div>
                      </div>
                    )}
                  </div>
            ...
            {item.dressdetail && (
              <DressDetails img={item.image} detailImg={item.dressdetail.img} />
            )}
            {item.washdetail && (
              <WashDetail img={item.image} detailImg={item.dressdetail.img} />
            )}
          </div>
        );
      })}
