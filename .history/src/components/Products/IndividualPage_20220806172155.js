            ...
            <div className="individualleft__column">
              <div className="individualleft__mainimg">
                <div>
                  ...
                  Assumenda repellendus ad sunt cum adipisci molestias hic
                  accusantium odit id, aperiam impedit deserunt excepturi
                  eligendi aut, commodi, minus unde animi ratione!
                </div>
                <InnerImageZoom
                  src={item.image}
                  zoomSrc={item.image}
