                  ...
                  <div className="product__info">
                    ...
                    {item.details && (
                      <div>
                        ...
                        >
                          <strong>Brand :</strong> <p>{item.details.brand}</p>
                          <strong>Color :</strong> <p>{item.details.color}</p>
                          <strong>Connectivity Technology:</strong>
                          <p> {item.details.connectivity}</p>
                          <strong>Model :</strong> <p> {item.details.model}</p>
                          <strong>Noise :</strong> <p> {item.details.noise}</p>
                        </div>
                      </div>
                    )}
                  </div>
