                ...
                <div className="product__description">
                  ...
                  <div className="product__info">
                    <p className="product__description">
                      ...
                      {item.details && (
                        <div>
                          <ProductDetails  brand={item.details.brand} color={item.details.color}connectivity={item.details.connectivity}model={item.details.model}, noise={item.details.noise}/>
                        </div>
                      )}
