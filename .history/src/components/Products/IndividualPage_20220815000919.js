      ...
      {itembox.map((item, index) => {
        return (
          <div key={index}>
                  ...
                  <div className="product__info">
                    ...
                    {item. && (
                      ...
                      >
                        ...
                        <div>
                          <p>{item.dressdetails.brand}</p>
                          <p>{item.dressdetails.color}</p>
                          <p> {item.dressdetails.connectivity}</p>
                          <p> {item.dressdetails.model}</p>
                          <p> {item.dressdetails.noise}</p>
                        </div>
                      </div>
                    )}
                  </div>
            ...
            {item.dressdetails && <DressDetails img={item.image} />}
          </div>
        );
      })}
