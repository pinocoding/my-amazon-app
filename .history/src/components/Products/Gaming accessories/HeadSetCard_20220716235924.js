      ...
      <div className="headsetscard__cell">
        ...
        <div className="headsetscard__cell__info">
          ...
          <div className="description">
            ...
            illum numquam magnam labore doloribus, molestias ipsam voluptatem
            nisi expedita quo sed laborum corrupti dolorum provident eveniet hic
            perspiciatis dignissimos itaque.
          </div>
