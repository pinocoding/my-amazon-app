      ...
      <div className="headsets__container">
        <div className="headsets__containeroptions">
          ...
          <ul className="headsets__optionsleftlist">
            ...
            <li>
              PC Accessories PC Game Headsets PlayStation 4 Headsets PlayStation
              Legacy Systems Xbox One Accessories PlayStation 5 Headsets
              Nintendo Legacy Systems Mac Game Headsets
            </li>
          </ul>
        </div>
