...
function AuthProvider({ children }) {
  ...
  const [relatedChairsList, setRelatatedChairsList] = useState([]);
  const [relatedKeyList, setRelatatedKeyList] = useState([]);
  const [relatedHeadsList, setRelatatedHeadsList] = useState([]);
  const [relatedHeadsList, setRelatatedHeadsList] = useState([]);
