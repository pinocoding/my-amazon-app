...
function AuthProvider({ children }) {
  //
  const [relatedHeadsList, setRelatedHeadsList] = useState([]);
  const [relatedChairsList, setRelatedChairsList] = useState([]);
  const [relatedKeysList, setRelatedKeysList] = useState([]);
  const [relatedMousesList, setRelatedMousesList] = useState([]);
  //
  const [SellersInBook, setTopSellersInBook] = useState([]);
  ...
  //useEffect (())
  useEffect(() => {
    const fetchRelatedHeadsData = async () => {
      await firebase
        .firestore()
        .collection("topsellersinbook")
        .orderBy("id", "desc")
        ...
        .onSnapshot(function (querySnapshot) {
          ...
          setTopSellersInBook(items);
        });
    };
    fetchRelatedHeadsData();
  }, []);
  useEffect(() => {
    const fetchRelatedHeadsData = async () => {
      await firebase.firestore().collection("headsets").orderBy("id", "desc"),
        limit(5).onSnapshot(function (querySnapshot) {
          const items = [];
          querySnapshot.forEach(function (doc) {
            items.push({ key: doc.id, ...doc.data() });
          });

          setRelatedHeadsList(items);
        });
    };
    fetchRelatedHeadsData();
  }, []);
  useEffect(() => {
    const fetchRelatedChairsData = async () => {
      await firebase
        .firestore()
        .collection("chairs")
        .orderBy("id", "desc")
        ...
        .onSnapshot(function (querySnapshot) {
          ...
          setRelatedChairsList(items);
        });
    };
    fetchRelatedChairsData();
  }, []);
  useEffect(() => {
    const fetchRelatedKeysData = async () => {
      await firebase
        .firestore()
        ...
        .onSnapshot(function (querySnapshot) {
          ...
          setRelatedKeysList(items);
        });
    };
    fetchRelatedKeysData();
  }, []);
  useEffect(() => {
  ...
  useEffect(() => {
    const fetchRelatedMousesData = async () => {
      await firebase
        .firestore()
        .collection("mouses")
        .orderBy("id", "desc")
        ...
        .onSnapshot(function (querySnapshot) {
          ...
          setRelatedMousesList(items);
        });
    };
    fetchRelatedMousesData();
  }, []);
