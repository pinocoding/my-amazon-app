              ...
              <div onClick={scrollToTop} className="slider__img">
                <div className="card">
                  ...
                  <h2 className="card__title">
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                    Rerum aliquid, delectus, veniam soluta rem vero suscipit
                    blanditiis accusantium explicabo nisi eum quae nam
                    consectetur maxime alias saepe. Quia, nemo? Odit!
                  </h2>
                  <p className="price">
                    <strong>$</strong>999
                  </p>
                  ...
                  <p className="card__description">
                    ...
                    Tempora, beatae et perspiciatis dolor accusantium non
                    obcaecati nostrum quod cumque deleniti laudantium eligendi
                    molestias illo debitis atque veritatis ullam doloremque
                    nemo!
                  </p>
                </div>
              </div>
