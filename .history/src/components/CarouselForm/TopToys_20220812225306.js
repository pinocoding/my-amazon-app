...
function TopToys({ keyExtractor }) {
  ...
  return (
    <div className="container">
      <div key={keyExtractor} className="topsellercarousel">
        <Slider {...settings}>
          <Link  to="/Toys">
            <div
            ...
            >
              ...
              <div className="card__carrouselTitle">
                ...
                Reprehenderit quaerat soluta nemo eum ipsam molestiae assumenda.
                Quod provident maiores aliquam voluptas quibusdam aspernatur
                assumenda maxime placeat itaque delectus? Ducimus, at?
              </div>
