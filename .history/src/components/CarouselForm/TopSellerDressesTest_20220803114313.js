          ...
          <Slider {...settings}>
            ...
            <Link to="/VideoGames">
              <div className="card__carrousel">
                ...
                <div className="card__carrouselImg">
                  <img
                    src="https://img.freepik.com/free-vector/retro-gadgets-cartoon-posters-with-camera-radio-musical-player-phone-tv-alarm-clock_1284-15301.jpg?size=626&ext=jpg&uid=R76010792&ga=GA1.2.826934667.1658638639"
                    alt=""
                  />
                </div>
                <div className="card__carrouselTitle">
