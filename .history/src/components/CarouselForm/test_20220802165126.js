              ...
              <div className="card">
                <div className="card__sales">
                  ...
                  <h2 className="card__title">
                    ...
                    Recusandae unde aliquid, porro magni deserunt fuga
                    excepturi! Repellat dolore tempore officia illo maxime
                    ullam, quod alias totam fugiat eligendi, cumque reiciendis?
                  </h2>
                  <p className="price">
                    <strong>$</strong>999
                  </p>
