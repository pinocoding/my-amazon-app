          ...
          <Slider {...settings}>
            ...
            <Link to="/VideoGames">
              <div className="card__carrousel">
                ...
                <div className="card__carrouselImg">
                  <img
                    src="https://img.freepik.com/free-vector/delicious-ramen-soup-background_52683-46005.jpg?size=626&ext=jpg&uid=R76010792&ga=GA1.2.826934667.1658638639"
                    alt=""
                  />
                </div>
                <div className="card__carrouselTitle">
            ...
            <Link to="/VideoGames">
              <div className="card__carrousel">
                ...
                <div className="card__carrouselImg">
                  <img
                    src="https://img.freepik.com/free-psd/retro-style-text-effect_23-2148989644.jpg?size=626&ext=jpg&uid=R76010792&ga=GA1.2.826934667.1658638639"
                    alt=""
                  />
                </div>
                <div className="card__carrouselTitle">
            ...
            <Link to="/VideoGames">
              <div className="card__carrousel">
                ...
                <div className="card__carrouselImg">
                  <img
                    src="https://img.freepik.com/free-vector/japanese-wave-line-art-landscape-background-abstract-mountain-banner-design-pattern-vector-illustration-geometric-poster_90220-715.jpg?size=626&ext=jpg&uid=R76010792&ga=GA1.2.826934667.1658638639"
                    alt=""
                  />
                </div>
                <div className="card__carrouselTitle">
            ...
            <Link to="/VideoGames">
              <div className="card__carrousel">
                ...
                <div className="card__carrouselImg">
                  <img
                    src="https://img.freepik.com/free-vector/vintage-chinese-food_1045-95.jpg?size=338&ext=jpg&uid=R76010792&ga=GA1.2.826934667.1658638639"
                    alt=""
                  />
                </div>
                <div className="card__carrouselTitle">
