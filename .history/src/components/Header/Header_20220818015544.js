...
function Header() {
  const ref = useRef();
  const [textActive, setTextActive] = useRef(false);
  ...
  return (
    <div>
      <div className="header ">
        ...
        <div
          className={isActive ? "header-overlay" : "header-noneoverlay"}
        ></div>
              ...
              <ul>
                ...
                {subActive && (
                  <ul className="header__navDropDownActiveListTwo">
                    <li style={styleLi}>
                      <a href="#Gaminggears-section">{t("Kindle E readers")}</a>
                    </li>
                    <li style={styleLi}>
                      <a href="#Dresses-section">{t("Dresses")}</a>
                    </li>
                    <li style={styleLi}>
                      <a href="#Toys-section">{t("Shop Pet supplies")}</a>
                    </li>
                    <li style={styleLi}>
                      <a href="#Swatches-section">{t("Top Smart Watches")}</a>
                    </li>
