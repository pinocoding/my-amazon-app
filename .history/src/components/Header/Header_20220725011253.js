...
function Header() {
  ...
  const cartProduct= context.cartUserProduct
      ...
      <div className="header">
        ...
        <div className="header__nav">
          ...
          <div className="header__optionBasket" >
            ...
            <span className="header__optionLineTwo header__basketCount">{cartProduct.length>0 ?
              <span style={{color:"orange"}}>{cartProduct.length}</span> :
