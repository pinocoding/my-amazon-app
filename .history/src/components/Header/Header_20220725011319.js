      ...
      <div className="header">
        ...
        <div className="header__nav">
          ...
          <div className="header__optionBasket" >
            ...
            <span className="header__optionLineTwo header__basketCount">{cartUserProduct.length>0 ?
              <span style={{color:"orange"}}>{cartUserProduct.length}</span> :
              <span>{cartUserProduct.length}</span>
