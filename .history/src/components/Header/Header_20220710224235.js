...
function Header() {
  ...
  const HandleConext = useContext(AuthContext);
  ...
  return (
    <div>
      <div className="header">
        <div className="Header__Modal" style={ModalBackground}>
          <div className="Header__Overlay" style={ModalLayout}></div>
        </div>
        ...
        <div className="header__nav">
          ...
          <div className="header__option " onMouseEnter={handleMouseEnter}>
