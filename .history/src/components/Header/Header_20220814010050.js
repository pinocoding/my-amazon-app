      ...
      <div className="header__navResponsive">
        <div className="header__navResponsiveTop">
          <div>
            ...
            <div className="header__navResponsiveTopLang">lang</div>
          </div>
              ...
              <ul>
                ...
                {subActive && (
                  <ul className="header__navDropDownActiveListTwo">
                    <li style={styleLi}>
                      <a href="#Gaminggears-section">Gaming gears</a>
                    </li>
                    <li style={styleLi}>
                      <a href="#Dresses-section">Dresses</a>
                    </li>
                    <li style={styleLi}>
                      <a href="#Toys-section">Video</a>
                    </li>
                    <li style={styleLi}>
                      <a href="#Toys-section">Toys</a>
                    </li>
                    <li style={styleLi}>
                      <a href="#Toys-section">Toys</a>
                    </li>
                ...
                {active && (
                  <ul className="header__navDropDownActiveListTwo">
                    ...
                    <li
                      style={styleLi}
                      onClick={() => setThirdActive((oldState) => !oldState)}
                    >
                      Language
                      {thirdActive ? (
                        <KeyboardArrowDownIcon />
                    ...
                    {thirdActive && (
                      <ul>
                        <li style={styleLISec}>Eng</li>
                        <li style={styleLISec}>日本</li>
                        <li style={styleLISec}>Vie</li>
                      </ul>
                    )}
                  </ul>
                )}
