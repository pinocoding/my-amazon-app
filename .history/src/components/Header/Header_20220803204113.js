        ...
        <div className="header__nav">
          ...
          >
            <div className="header__optionLineTwo header__optionLanguages">
              <select className="header__optionLineTwo header__optionLanguages" value={selected} onChange={handleChange}>
                <option value="0">
                  <span>En</span>
                </option>
                <option value="1"><span>日本語</span></option>
                <option value="2"><span>Viet</span></option>
              </select>
      ...
      <div className="header__navResponsive">
        ...
        >
          <div className="header__navDropDownActiveContainer">
            ...
            <CloseIcon onClick={handleClose} className="header__closeIcon" />
            <ArrowBackIcon
