    ...
    <div className="home">
      <div className="home__container">
        ...
        <div className="home__row">
          ...
          <Product />
          id={323131312}
          title="he Lean Startup: How Today's Entrepreneurs Use Continuous
          Innovation to Create Radically Successful Businesses Hardcover -
          September 13, 2011" price={29.99}
          image="https://m.media-amazon.com/images/I/41rzRPDRxJL.jpg" rating={4}
          />
          <Product /> */}
        </div>
        <div className="home__row">
