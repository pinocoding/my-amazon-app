    ...
    <div className={`login ${isDark ? "login-dark" : "login-light"}`}>
      <Link to="/">
        <img
          ...
          alt="#"
          src= {isDark ?     "https://help.pacisoft.com/wp-content/uploads/2017/11/amazon-logo-preview.png" : "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRyA0ZAYhqvzJyOPS3B0KErnp8SMvq5SRTzuYpAt_NIYKvuuxQvoL7iKO8bUg3v7YC9eEQ&usqp=CAU"
