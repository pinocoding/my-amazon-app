...
function UpdateProfile() {
  ...
  const promises = [];
  console.log("context.fullName", context.fullName);
  console.log("currentUser.fullName", currentUser.displayName);
  if (context.fullName !== currentUser.displayName) {
    promises.push(updateFullName(context.fullName));
  }
